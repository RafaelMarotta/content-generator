...
def generate_question_image(
    ...
    img_output_dir=os.path.join(output_dir,"question/img")
    ...
    for i in range(1, len(words) + 1):
        ...
        output_image_path = os.path.join(img_output_dir, f"{i}.png")
        ...
        image_generator.generate_quiz_image(params, output_dir=output_dir)
...
def generate_options_images(
    ...
    # Ensure the output directory exists
    img_output_dir = os.path.join(output_dir,"options/img")
    os.makedirs(img_output_dir, exist_ok=True)
    ...
    for step in range(1, len(answers) + 1):
        ...
        output_image_path = os.path.join(img_output_dir, f"{step}.png")
...
def generate_timer_image(
    ...
    # Ensure the output directory exists
    img_output_dir = os.path.join(output_dir,"timer/img")
    os.makedirs(img_output_dir, exist_ok=True)
    ...
    for progress_percentage in range(0, 101, 10):
        ...
        output_image_path = os.path.join(img_output_dir, f'progress_{progress_percentage}.png')
...
def generate_correct_answer_image(
    ...
    # Ensure the output directory exists
    img_output_dir = os.path.join(output_dir,"correct/img")
    os.makedirs(img_output_dir, exist_ok=True)

    final_output_image_path = os.path.join(img_output_dir, "1.png")
